<!DOCTYPE html>
<%@page import="com.mycompany.logic.ClusteringLogic"%>
<%@page import="com.mycompany.action.*"%>
<%@page import="com.mycompany.logic.*"%>
...
<head>
    ...
    <title>Twitter tweets fetch</title>
   	    ...
   	    nodeSelected: function(node){
   	     ...
   	     $.getJSON('ResponseAction.action?ids='+node.data.allData.id,function(data) {
   	    	...
   	    	$.each(data.responseList, function(key, val) {
   	    			var eachRow='<tr> <td> '+ val.id +'</td>  <td> '+ val.hashTag +'</td> <td> '+ val.text +'</td>  </tr>';
...
System.out.println("session data in clustering.jsp >>>>>>>>>>>>>>>>>>>>>>>>>>>>>"+topic); %> --%>
