...
//						{
//					    	flag11= AdminDAO.storeintodatabaseapple(part1, part3, part4,part5);
//					    	
//						}
//					
//						if(part1.equals("google"))
//						{
//							flag22= AdminDAO.storeintodatabasegoogle(part1, part3, part4, part5);
//						}
//						
//						if(part1.equals("microsoft"))
//						{
//							flag33=AdminDAO.storeintodatabasemicrosoft(part1, part3, part4, part5);
//						}
//						
//						if(part1.equals("twitter"))
//						{
//							flag44=AdminDAO.storeintodatabasetwitter(part1, part3, part4, part5);
//						}
//						}	
					 ...
					 flag1=AdminDAO.storeoriginalcontents(part1,part2,part3,part4,part5);
		...
		if(flag1)
		{
			...
			rd=request.getRequestDispatcher("/Files/JSP/User/success.jsp?no1=5");
