...
public final class changepass_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(Utility.parse(request.getParameter("no"))==0)
	{
      ...
      out.write("\t    \r\n");
      out.write("\t    <h2 align=\"center\"><font color=\"black\"  size=\"6\">Change Password</font></h2>\r\n");
      out.write("\t    \r\n");
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\tUserID:<input type=\"text\"  name=\"userid\" value=\"");
      out.print(uname);
      out.write("\" required=\"required\" width=\"200px\"></input>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr id=\"label\" align=\"center\">\r\n");
      ...
      out.write("\t\t\t<td align=\"justify\" colspan=\"3\">\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\tOld Password:<input type=\"text\"  name=\"oldpass\"  required=\"required\" width=\"200px\"></input>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr id=\"label\" align=\"center\">\r\n");
      ...
      out.write("\t\t\t<td align=\"justify\" colspan=\"3\">\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\tNew Password:<input type=\"text\"  name=\"newpass\"  required=\"required\" width=\"200px\"></input>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr id=\"label\" align=\"center\">\r\n");
      ...
      out.write("\t\t\t<td align=\"justify\" colspan=\"3\">\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\tConfirm Password:<input type=\"text\"  name=\"conpass\"  required=\"required\" width=\"200px\"></input>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t\t\t<input type=\"submit\" class=\"gradientbuttons\" value=\"Changepass\" onclick=\"return check();\"></input>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t    </tr>\r\n");
      out.write("\t\r\n");
      out.write("\t</table>\r\n");
	...
	if(Utility.parse(request.getParameter("no1"))==2)
	{
      ...
      out.write("\t\t\t\t<p>Sorry!!! Confirm Password is not matching</p>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t");
	...
	if(Utility.parse(request.getParameter("no1"))==3)
	{
      ...
      out.write("\r\n");
      out.write("\t\t\t<div class=\"error\" id=\"message\" style=\"position:absolute;top:300px;left:300px\">\t\r\n");
      out.write("\t\t\t\t<p>Sorry!!! Change Password Failed</p>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t");
